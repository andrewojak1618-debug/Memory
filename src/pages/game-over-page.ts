import '../styles/entries/game-over-page.scss';
import { getColorLabel, getOpponentColor } from '../shared/player-color';
import { getDevelopmentResult } from '../results/result-debug';
import { loadGameResult, saveGameResult } from '../results/result-data';
